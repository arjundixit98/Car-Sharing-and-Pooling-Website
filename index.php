...
<html lang="en">
  <head>
    ...
    <title>Car Sharing and Pooling Website</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDggofUxTHuVIyd7vsZooPN7JLaA-MvY7E"></script>
      ...
      <div class="container-fluid" id="myContainer">
          <div class="row">
              <div class="col-md-6 col-md-offset-3">
                  ...
                  <p class="bold">You can save a lot of money each time you use Car Sharing
                  </p>
                  <!--Search Form-->
